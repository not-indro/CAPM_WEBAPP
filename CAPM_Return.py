...
st.markdown('###### Made with 💛 by Indranil Bain | [↗ to github](https://github.com/not-indro) | [↗ to Portfolio website](https://not-indro.github.io/Portfolio/)')
...
with col1:
    stocks_list = st.multiselect("Choose 4 Stocks", ('TSLA', 'AAPL', 'NFLX', 'MGM', 'MSFT', 'AMZN', 'NVDA', 'GOOGL'), [
